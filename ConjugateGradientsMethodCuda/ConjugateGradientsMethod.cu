...
// ядро cбора значений cкал€рных произвдений
...
// –аccчет коэфициентов тау и альфа
...
// ѕолучить результаты cкал€рных умножений c куда
...
// »тераци€ ћетода cопр€женных градиентов
